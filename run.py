...
parser.add_argument('--network_matrix_estimation', help="What method to employ for network matrix estimation. Choices are 'correlation' = correlation,'partial-correlation' = partial correlation,'ridge-partial-correlation' = regularized partial correlation, 'intrinsic-connectivity' = intrinsic connectivity, "
                                                        "'global-correlation' = global correlation, 'local-correlation' = local correlation, 'radial-correlation' = radial correlation, 'radial-similarity = radial similarity")
